  ...
  privacy: {
    ...
    sections: [
      ...
      { h: "5. שירותי צד שלישי", p: [
        ...
        "כמו כן אנו משתמשים בפיקסל של Meta למדידת ביצועי הפרסום שלנו. הפיקסל נטען אך ורק לאחר שאישרת זאת בבאנר ההסכמה; אם בחרת \"דוחה\" — הוא אינו נטען כלל ולא נשלח ל-Meta מידע מהגלישה שלך באתר.",
      ]},
      { h: "6. עוגיות והסכמה", p: [
        "עוגיות פרסום (בהסכמה בלבד): העוגיות היחידות שנטענות באתר לצורכי פרסום הן אלו של פיקסל Meta, ורק לאחר אישור מצידך. ניתן לשנות את הבחירה בכל רגע בלחיצה על \"ניהול עוגיות\" בפינה התחתונה של האתר, וכן לחסום עוגיות דרך הגדרות הדפדפן.",
