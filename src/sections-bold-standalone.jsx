    ...
    <section style={{ position: "relative", padding: "100px 0 60px", overflow: "hidden" }}>
      <div className="wrap" style={{ position: "relative" }}>
        ...
        <h1 className="display" style={{
          ...
          תפסיק למכור.<br/>
          <span style={{ color: "var(--accent)" }}>תתחיל שיקנו ממך.</span>
        </h1>
      ...
      <div className="wrap">
        ...
        <div style={{
          ...
          {[
            ...
            { n: `${attention} שניות`, label: "קשב ממוצע על מסך", sub: "ירד מ־2:30 דקות ב־2004", arrow: "→", tone: "bad" },
          ].map((s, i) => (
            <div key={i} style={{
              padding: "32px 28px",
              background: "var(--bg)",
    ...
    <section style={{
      ...
      <div style={{ position: "relative" }}>
        ...
        <div className="guest-marquee-row" style={{
          ...
          <img src={(window.__resources && window.__resources.guestsRow1) || "assets/guests-row-1.png"} alt="" style={{ height: 260, width: "auto", display: "block", flexShrink: 0 }} />
          <img src={(window.__resources && window.__resources.guestsRow1) || "assets/guests-row-1.png"} alt="" style={{ height: 260, width: "auto", display: "block", flexShrink: 0 }} aria-hidden="true" />
        </div>
        ...
        <div className="guest-marquee-row" style={{
          ...
          <img src={(window.__resources && window.__resources.guestsRow2) || "assets/guests-row-2.png"} alt="" style={{ height: 260, width: "auto", display: "block", flexShrink: 0 }} />
          <img src={(window.__resources && window.__resources.guestsRow2) || "assets/guests-row-2.png"} alt="" style={{ height: 260, width: "auto", display: "block", flexShrink: 0 }} aria-hidden="true" />
        </div>
      </div>
