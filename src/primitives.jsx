...
},
{
  ...
  a: "תלוי לגמרי בך, ברגע שהתחלנו תהליך המימוש תלוי בזמינות האולפן ובזמינות שלך, זה יכול להיות בין שעתיים לארבע שעות בחודש."
},
{
  q: "מה אם אין לי אורחים?",
  a: "יש כמה דרכים לפתור את זה, זה בעיקר תלוי באופן שבו אתה ניגש לזה ובאיך אתה מתקשר את זה לאורחים פוטנציאליים, יש לנו גם קהילה משלנו שאפשר לעשות חיבורים רלוונטיים ולמצוא אנשים לארח, נוכל לדבר על זה בפגישת האסטרטגיה אחרי פרק ההיכרות."
},
{
...
},
{
  ...
  a: "השאלה הנכונה היא לא גודל העסק אלא האסטרטגיה והחיבור שלך לפורמט של פודקאסט, אם האסטרטגיה טובה ומתאימה ויהיה לך חיבור לפורמט - זה בהחלט מתאים ושוב גם את זה נוכל לוודא בפגישת האסטרטגיה, אפשר גם להשאיר פרטים כדי לדבר טלפונית ולבחון את זה יחד."
},
{
